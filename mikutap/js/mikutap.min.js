...
var MainManager = function() {
	...
	function() {
		...
		this.init = function(t, o) {
			f = o,
			c = t;
			for (var r = [], l = 0; l < i; l++) r[l] = [l + ".mp3"]; (n = new WebAudioManager).load("data/track/track.json", r, a, e)
		},
	...
	function() {
		...
		this.init = function(n, t) {
			h = t,
			d = n;
			for (var r = [], l = 0; l < o; l++) r[l] = [l + ".mp3"]; (i = new WebAudioManager).load("data/main/main.json", r, a, e)
		},
